...
### iOS Protobuf Version Compatibility
...
These indicate protoc/Protobuf version incompatibility. Install a compatible protoc version:
```bash
brew install protobuf@21
```
Then regenerate the protobuf files. See [iOS_SETUP.md](iOS_SETUP.md) for detailed instructions.
